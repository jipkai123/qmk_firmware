...
[_GAME] = LAYOUT(
    ...
    KC_LCTL  ,_______,_______,_______,_______,_______,            _______,_______,_______,_______,_______,_______,    \
                                  KC_M,KC_SPC,    KC_RALT|KC_F4,BASE,                                    \
                                    KC_4,_______,_______,_______,_______,_______                                  \
),

[_LOWER] = LAYOUT(
    KC_TAB | KC_RALT,_______,_______,_______,_______,KC_LBRC,            KC_RBRC, KC_P7, KC_P8,  KC_P9,  RESET,  KC_PLUS,   \
...
[_RAISE] = LAYOUT(
    ...
    _______,GAME,_______,_______,_______,_______,            _______,_______,_______,_______,_______,KC_VOLD,   \
                                     ...
                                     _______,KC_SPC,KC_TAB,KC_HOME, KC_ENT,KC_LCTRL | KC_LSHIFT | KC_ESC                                  \
)
};
